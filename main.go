...
type News struct {
	...
	HeadlineLink string `xml:"news_item_uri"`
}
...
func main() {
	...
	for i := range r.Channel.ItemList {
		...
		if len(r.Channel.ItemList[i].NewsItems) > 0 {
...
func getGoogleTrends() *http.Response {
	resp, err := http.Get("https://trends.google.com/trends/trendingsearches/daily/rss?geo=NG")
